...
async function gerarResposta(nivelTreino,grupoMuscular,idade) {
    try {
        const modeloIA = chatIA.models.generateContent({
            ...
            contents: `Dê no máximo 5 exercícios de ${grupoMuscular}, para um praticante ${nivelTreino} com idade ${idade}, utilizando no maximo 20 palavras para cada. Separe cada exercicio com uma linha.`
        });
